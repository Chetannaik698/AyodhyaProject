...
const VegMain = () => {
  return (
    <div className="menu-container">
      ...
      <div className="menu-section">
        <h2 className="menu-heading">INDIAN BREAD</h2>
        <ul className="menu-list">
          <li>
            <span className="item-name">Roti</span>{" "}
          ...
          <li>
            <span className="item-name">Kulcha</span>{" "}
          ...
          <li>
            <span className="item-name">Naan</span>{" "}
            <span className="item-price">40</span>
          </li>
          <li>
            <span className="item-name">Butter Naan</span>{" "}
            <span className="item-price">50</span>
          </li>
          <li>
            <span className="item-name">Tandoori Parota</span>{" "}
            <span className="item-price">40</span>
          </li>
          <li>
            <span className="item-name">Aloo Parata</span>{" "}
            <span className="item-price">70</span>
          </li>
          <li>
            <span className="item-name">Stuff Parata</span>{" "}
            <span className="item-price">100</span>
          </li>
          <li>
            <span className="item-name">Butter Garlic Naan</span>{" "}
            <span className="item-price">70</span>
          </li>
          <li>
            <span className="item-name">Cheese Garlic Naan</span>{" "}
            <span className="item-price">80</span>
          </li>
          <li>
            <span className="item-name">Roti Basket</span>{" "}
            <span className="item-price">450</span>
          </li>
          <li>
            <span className="item-name">Chapati</span>{" "}
            <span className="item-price">15</span>
          </li>
          <li>
            <span className="item-name">Butter Chapati</span>{" "}
            <span className="item-price">25</span>
          </li>
        </ul>
      </div>
      ...
      <div className="menu-section">
        <h2 className="menu-heading">CHINESH RICE AND NOODLES</h2>
        <ul className="menu-list">
          <li>
          ...
          <li>
            <span className="item-name">Veg Schezwan Fried Rice</span>{" "}
            <span className="item-price">150</span>
          </li>
          <li>
            <span className="item-name">Veg Burnt Garlic Fried Rice</span>{" "}
            <span className="item-price">160</span>
          </li>
          <li>
            <span className="item-name">Paneer Fried Rice</span>{" "}
            <span className="item-price">160</span>
          </li>
          <li>
            <span className="item-name">Mushroom Fried Rice</span>{" "}
            <span className="item-price">160</span>
          </li>
          <li>
            <span className="item-name">Veg Hakka Noodles</span>{" "}
            <span className="item-price">120</span>
          </li>
          <li>
            <span className="item-name">Veg Singapore Noodles</span>{" "}
            <span className="item-price">150</span>
          </li>
          <li>
            <span className="item-name">Veg Schezwan Noodles</span>{" "}
            <span className="item-price">150</span>
          </li>
          <li>
            <span className="item-name">Masala Rice</span>{" "}
            <span className="item-price">130</span>
          </li>
        </ul>
      </div>
      ...
      <div className="menu-section">
        <h2 className="menu-heading">RICE PREPARATION</h2>
        <ul className="menu-list">
          <li>
            <span className="item-name">Steam Rice</span>{" "}
          ...
          <li>
            <span className="item-name">Special Curd Rice</span>{" "}
            <span className="item-price">100</span>
          </li>
          <li>
          ...
          <li>
            <span className="item-name">Dal Kitchadi</span>{" "}
            <span className="item-price">160</span>
          </li>
          <li>
            <span className="item-name">Palak Kitchadi</span>{" "}
            <span className="item-price">160</span>
          </li>
          <li>
          ...
          <li>
            <span className="item-name">Kashmiri Pulao</span>{" "}
            <span className="item-price">180</span>
          </li>
          <li>
            <span className="item-name">Veg Biriyani</span>{" "}
            <span className="item-price">150</span>
          </li>
          <li>
            <span className="item-name">Paneer Biriyani</span>{" "}
            <span className="item-price">180</span>
          </li>
          <li>
            <span className="item-name">Mushroom Biriyani</span>{" "}
            <span className="item-price">180</span>
          </li>
        </ul>
      </div>
      ...
      <div className="menu-section">
        <h2 className="menu-heading">SOUP</h2>
        <ul className="menu-list">
          <li>
            <span className="item-name">Cream Of Tomato Soup</span>{" "}
            <span className="item-price">80</span>
          </li>
          <li>
            <span className="item-name">Cream Of Veg Soup</span>{" "}
            <span className="item-price">90</span>
          </li>
          <li>
            <span className="item-name">Cream Of Mushroom Soup</span>{" "}
            <span className="item-price">90</span>
          </li>
          <li>
          ...
          <li>
            <span className="item-name">Veg Hot & Sour Soup</span>{" "}
            <span className="item-price">80</span>
          </li>
          <li>
            <span className="item-name">Veg Lemon Coriander Soup</span>{" "}
            <span className="item-price">80</span>
          </li>
          <li>
            <span className="item-name">Veg Sweet Corn Soup</span>{" "}
            <span className="item-price">80</span>
          </li>
          <li>
            <span className="item-name">Veg Burnt Garlic Soup</span>{" "}
            <span className="item-price">90</span>
          </li>
        </ul>
      </div>
      ...
      <div className="menu-section">
        <h2 className="menu-heading">SALAD AND RAITHA</h2>
        <ul className="menu-list">
          <li>
          ...
          <li>
            <span className="item-name">Cucumber Salad</span>{" "}
            <span className="item-price">60</span>
          </li>
          <li>
            <span className="item-name">Onion Salad</span>{" "}
            <span className="item-price">80</span>
          </li>
          <li>
      ...
      <div className="menu-section">
        <h2 className="menu-heading">NORTH THALI</h2>
        <ul className="menu-list">
          <li>
            <span className="item-name">North Thali</span>{" "}
            <span className="item-price">200</span>
          </li>
          <li>
            <span className="item-name">Two Type Subji</span>{" "}
          ...
          <li>
            <span className="item-name">Sweet</span>{" "}
            <span className="item-price">Included</span>
          </li>
          <li>
            <span className="item-name">Curd</span>{" "}
            <span className="item-price">Included</span>
          </li>
          <li>
            <span className="item-name">Soup</span>{" "}
            <span className="item-price">Included</span>
          </li>
          <li>
            <span className="item-name">Roti</span>{" "}
          ...
          <li>
            <span className="item-name">Papad</span>{" "}
            <span className="item-price">Included</span>
          </li>
        </ul>
      </div>
